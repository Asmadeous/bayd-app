...
services_data = [
  ...
  # Massage
  { category: "massage", name: "Massage",                                      duration: 60,  price: 95.00, desc: "A relaxing mobile massage tailored to your needs, designed to ease tension, support circulation, and help you reset in the comfort of your own space." },
  ...
  { category: "spa",     name: "Express facial",                              duration: 30,  price: 95.00, image: "/images/services/spa-facial.webp", desc: "A focused 30-minute facial designed to refresh the skin with cleansing, exfoliation, hydration, and a healthy glow when time is limited." },
  { category: "spa",     name: "Facial basic",                                 duration: 60,  price: 140.00, image: "/images/services/spa-facial.webp", desc: "A 60-minute personalized facial with cleansing, exfoliation, extractions as needed, massage, mask, and hydration for balanced, refreshed skin." },
  { category: "spa",     name: "Anti aging collagen boosting facial",          duration: 60,  price: 180.00, image: "/images/services/spa-facial.webp", desc: "A 60-minute anti-aging facial focused on hydration, firmness, and collagen-supporting care to help soften the appearance of fine lines and improve radiance." },
  { category: "spa",     name: "Back facial",                                  duration: 45,  price: 110.00, image: "/images/services/spa-facial.webp", desc: "A 45-minute back treatment with cleansing, exfoliation, extractions as needed, mask, and hydration to smooth and refresh hard-to-reach skin." },
  { category: "spa",     name: "Microdermabrasion add on",                     duration: 15,  price: 40.00, image: "/images/services/spa-facial.webp", desc: "A microdermabrasion add-on that gently resurfaces the skin to improve smoothness, brightness, and product absorption during a facial service." },
