...
### F-01 [P1] open - `no_show` status is never set by any code path
...
### F-02 [P1] open - No scheduled sweep detects overdue bookings or missed clock-ins
...
### F-03 [P1] open - Missed (tech fault) and no_show (client fault) are conflated with no resolution flow
...
### F-04 [P1] open - No post-appointment / appointment-start notification
